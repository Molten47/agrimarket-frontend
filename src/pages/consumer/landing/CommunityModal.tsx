...
export default function CommunityModal({ open, onClose, onTouchStart, onTouchEnd }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 22, fontWeight: 700, color: 'var(--foreground)', marginBottom: 6 }}>
          Join the community
        </p>
        <p style={{ fontSize: 14, color: 'var(--muted-foreground)', marginBottom: 28, lineHeight: 1.5 }}>
          Pick your platform — farmers, foodies & growers all welcome.
        </p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
          {SOCIALS.map(({ name, color, href, svg }) => (
            <a
              key={name}
              href={href}
              target="_blank"
        ...
        <p style={{ fontSize: 11, color: 'var(--muted-foreground)', marginTop: 20, textAlign: 'center' }}>
